...
class DoctorApprove extends StatefulWidget {
  const DoctorApprove({Key? key}) : super(key: key);

  @override
  State<DoctorApprove> createState() => _DoctorApproveState();
}

class _DoctorApproveState extends State<DoctorApprove> {
  bool value = false;
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              'Your have successfully scheduled an appointment with your patient...',
                              style: TextStyle(
                                  color: Color(0xFFffffff),
                                  fontSize: 18,
                                  fontWeight: FontWeight.w600,
