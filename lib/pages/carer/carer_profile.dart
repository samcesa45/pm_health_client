...
class CarerProfile extends StatefulWidget {
  const CarerProfile({Key? key}) : super(key: key);

  @override
  State<CarerProfile> createState() => _CarerProfileState();
}

class _CarerProfileState extends State<CarerProfile> {
          ...
          child: Container(
            decoration: const BoxDecoration(
              ...
              image: DecorationImage(
                  image: AssetImage('assets/carer_profiles.png'),
